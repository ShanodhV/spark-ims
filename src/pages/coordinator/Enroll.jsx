...
const Enroll = () => {
  const heading = 'Enrollment';
  const path = ['Coordinator', 'Enroll'];
          ...
          <CardContent>
            ...
            <Grid container spacing={2} alignItems="center"> {/* Added spacing */}
              <Grid item xs={12} sm={12} md={6}> {/* Adjusted grid size for smaller screens */}
                <LabelTypography variant="body1">Select Batch</LabelTypography>
                <SearchField
                  select
                  variant="outlined"
                  fullWidth
              ...
              <Grid item xs={12} sm={12} md={6}> {/* Adjusted grid size for smaller screens */}
                <LabelTypography variant="body1">Select Course</LabelTypography>
                <SearchField
                  select
                  variant="outlined"
                  fullWidth
